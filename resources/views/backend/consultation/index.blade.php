...
<a class="btn btn-primary" href="{{route('consultation.create')}}">ajouter
</a>
...
<a class="dropdown-item" href="{{route('consultation.show',$agent->id)}}"><i class="icofont icofont-eye-alt"></i>Dossier medical</a>
