...
<h5 style="text-align:center;">Liste des ordonances </h5>
...
<thead>
<tr>
<th>Date de lordonance</th>
<th>Nom du medecin</th>
<th>Specialité du medecin</th>
...
<tr>
<td>{{$ordonance->date}}</td>
<td>{{$ordonance->consultation->agentt->nom}}</td>
<td>{{$ordonance->consultation->agentt->specialite->specialite}}</td>
<td>{{$ordonance->consultation->patient->nom}}</td>
<td>{{$ordonance->consultation->patient->prenom}}</td>
<td>	
