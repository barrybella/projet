...
<a href="#!">
<img src="{{asset('assets/images/user.png')}}"style="height: 35px;width: 35px; border-radius: 50%;margin-right: 15px;" alt="User-Profile-Image">
...
<i class="ti-settings"></i> créer un compte
</a>
</li>
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src="{{asset('assetsassets/images/avatar-2.png')}}" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src="{{asset('assetsassets/images/task/task-u2.jpg')}}" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src="{{asset('assetsassets/images/task/task-u3.jpg')}}" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src="{{asset('assetsassets/images/avatar-3.png')}}" alt="Generic placeholder image">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src="{{asset('assetsassets/images/avatar-4.png')}}" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src="{{asset('assetsassets/images/avatar-5.png')}}" alt="Generic placeholder image">
<div class="live-status bg-danger"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src="{{asset('assetsassets/images/avatar-1.png')}}" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<img class="media-object img-circle m-t-5" src="{{asset('assetsassets/images/avatar-1.png')}}" alt="Generic placeholder image">
</a>
...
<a href="#!">
<img class="media-object img-circle m-t-5" src="{{asset('assetsassets/images/avatar-2.png')}}" alt="Generic placeholder image">
</a>
</div>
</div>
